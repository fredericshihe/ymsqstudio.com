-- 综合榜音符币周榜奖励下调 20%，与 2026-08-22 已调整的分类榜奖励保持一致。
--
-- 调整前 → 调整后（第1名 / 第2–3名 / 第4–6名 / 第7–10名）：
--   综合榜 100 / 80 / 60 / 40  →  80 / 64 / 48 / 32
--   稳定榜  50 / 35 / 20  →  12 / 9 / 5
--   守则榜  45 / 30 / 18  →  11 / 8 / 5
--   进步榜  40 / 25 / 15  →  10 / 6 / 4
...
BEGIN
    ...
    LOOP
        ...
        /* ─── 综合榜（下调20%：100/80/60/40 → 80/64/48/32） ── */
        IF r.board = '综合榜' THEN
...
COMMENT ON FUNCTION public.reward_weekly_coins() IS
    '每周五 BJT 21:32 自动结算四榜音符币。
     2026-08-22起：进步/稳定/守则榜奖励大幅下调；2026-08-27起综合榜奖励下调20%。
